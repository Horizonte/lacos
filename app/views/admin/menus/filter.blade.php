    ...
    <div class="modal-content">
        ...
        <form id="filterMenu" name="filterMenu" class="form-horizontal">
            <div class="modal-body" style="margin:3px;">
                <fieldset id="cmpFilters">
                    <div class="form-group">
                        <label class="control-label col-md-2" for="menu">N&iacute;vel</label>  
                        <div class="col-md-10">
                    ...
                    <div id="cmpMenu" class="form-group">
                        ...
                        <div id="divMenu" class="col-md-10">
                    ...
                    <div id="cmpSubmenu" class="form-group" display="none">
                        <label class="control-label col-md-2" for="name">Submenu</label>  
                        <div id="divSubmenu" class="col-md-10">
                    ...
                    <div id="cmpSubsubmenu" class="form-group" display="block">
                        <label class="control-label col-md-2" for="name">Sub-Submenu</label>  
                        <div id="divSubsubmenu" class="col-md-10">
                            <input id="subsubmenu" name="subsubmenu" type="text" placeholder="" class="form-control input-md" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-2" for="menu">Status</label>  
                        <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" for="menu">Diret&oacute;rio</label>  
                        <div class="col-md-10">
                            <select id="dir" name="dir" class="form-control">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="btClearFilter" name="btClearFilter" class="btn btn-sm btn-warning" form="filterMenu"><i class="glyphicon glyphicon-refresh"></i> Limpar</button>
